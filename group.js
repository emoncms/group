...
var group = {
    ...
    'adduserauth': function (groupid, username, password, access) {
        var result = {};
        $.ajax({url: path + "group/adduserauth", data: "groupid=" + groupid + "&username=" + username + "&password=" + password + "&access=" + access, dataType: 'json', async: false, success: function (data) {
                result = data;
            }});
        return result;
    },
