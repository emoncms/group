...
var group = {
  ...
  'removeuser':function(groupid,userid){
    var result = {};
    $.ajax({ url: path+"group/removeuser", data: "groupid="+groupid+"&userid="+userid, dataType: 'json', async: false, success: function(data){result = data;} });
    return result;
  },
  ...
  'deletegroup':function(groupid){
    var result = {};
    $.ajax({ url: path+"group/delete", data: "groupid="+groupid, dataType: 'json', async: false, success: function(data) {result = data;} });
    return result;
  },
